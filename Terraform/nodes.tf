resource "aws_eks_node_group" "team2_node_group_2" {
  cluster_name    = aws_eks_cluster.team2_cluster_2.name
  node_group_name = "team2-node-group-2"
  node_role_arn   = aws_iam_role.team2_node_role_2.arn
  subnet_ids      = [
...
resource "aws_iam_role" "team2_node_role_2" {
  name = "team2-node-role-2"
...
resource "aws_iam_role_policy_attachment" "team2_node_policy_attachment" {
  role       = aws_iam_role.team2_node_role_2.name
...
resource "aws_security_group" "eks_nodes_sg_2" {
